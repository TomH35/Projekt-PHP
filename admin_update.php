...
<main class="mt-5 mb-5">
        <section class="container">
          ...
          <div class="card w-50">
        <div class="card-body">
        <h2 class="text-center card-title"> <strong>Upraviť článok</strong></h2>
        <p class="card-text"><form class="needs-validation" action="inc/soc_clanok/update_soc.php" method="post" enctype="multipart/form-data" novalidate>
                <div>
                  <label for="clanok_nadpis" class="form-label">nádpis</label>
                  <input type="text" name="clanok_nadpis" class="form-control" maxlength="45" id="clanok_nadpis">
                ...
                <div class="mt-3">
                  ...
                  <input type="number" name="soc_id_clanku" class="form-control" maxlength="45" id="soc_id_clanku">
                  <div class="valid-feedback">
                  </div>
                  <div class="invalid-feedback">
                ...
                <div class="mt-3">
                  ...
                  <input type="text" name="soc_nazov" class="form-control" maxlength="45" id="soc_nazov">
                  <div class="valid-feedback">
                  </div>
                  <div class="invalid-feedback">
                   Musíte zadať názov
                ...
                <div class="mt-3">
                  ...
                  <textarea id ="soc_jadra" name="soc_jadra" class="form-control"></textarea>
                  <div class="valid-feedback">
                  </div>
                    <div class="invalid-feedback">
               ...
               <button class="btn custom-button-color" value="Update" name="update_soc" type="submit">Vytvoriť</button>
                </div>
              </form></p>
        </div>
        </div>
